...
import DiseaseDetection from '../components/member/DiseaseDetection';
...
export default function MemberDeviceDisease() {
  ...
  return (
    <DeviceLayout 
      ...
      title={`Deteksi Penyakit - ${device.name}`}
    >
      {/* Use existing DiseaseDetection component */}
      <DiseaseDetection />
    </DeviceLayout>
  );
}